...
SALT_FILES : Tuple[Union[Path, targets.FileTarget], ...] = (
    ...
    targets.TemplateFile(
        ...
        source=constants.ROOT/'salt'/'metalk8s'/'mark-control-plane'/'configured.sls.in',
        destination=constants.ISO_ROOT/'salt'/'metalk8s'/'mark-control-plane'/'configured.sls',
        context={'VERSION': constants.SHORT_VERSION},
        file_dep=[constants.VERSION_FILE],
    ),
